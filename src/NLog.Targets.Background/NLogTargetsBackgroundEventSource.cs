...
sealed class NLogTargetsBackgroundEventSource : EventSource
{
  public static readonly NLogTargetsBackgroundEventSource Log = new();

  const string EventSourceName = "NLog.Targets.Background";
  ...
  internal NLogTargetsBackgroundEventSource() : base(EventSourceName) {}
